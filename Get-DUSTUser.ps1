...
@('distinguishedName', 'enabled', 'givenName', 'name', 'samAccountName', 'sn', 'userPrincipalName', 'displayName', 'employeeNumber', 'extensionAttribute6', 'extensionAttribute4', 'company', 'department', 'pwdLastSet', 'whenChanged', 'whenCreated', 'lockedOut', 'mail', 'proxyAddresses', 'state', 'title') | ForEach-Object {
